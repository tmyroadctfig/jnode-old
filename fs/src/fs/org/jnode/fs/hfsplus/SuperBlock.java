...
public class SuperBlock extends HfsPlusObject {
	 ...
	 */
	public SuperBlock(final HfsPlusFileSystem fs) {
		super(fs);
	...
	public void read() throws FileSystemException {
		...
		try {
			...
			if (getMagic() != HFSPLUS_SUPER_MAGIC
					&& getMagic() != HFSX_SUPER_MAGIC) {
				throw new FileSystemException("Not hfs+ volume header ("
						+ getMagic() + ": bad magic)");
			}
	...
	public void create(HFSPlusParams params) throws IOException {
		...
		long blockUsed = 2 + burnedBlocksBeforeVH + burnedBlocksAfterAltVH
				+ bitmapBlocks;
		int startBlock = 1 + burnedBlocksBeforeVH;
		int blockCount = (int) bitmapBlocks;
		HfsPlusForkData forkdata = new HfsPlusForkData(allocationClumpSize,
				(int) allocationClumpSize, (int) bitmapBlocks);
		...
		forkdata = new HfsPlusForkData(params.getExtentClumpSize(),
				params.getExtentClumpSize(),
		...
		forkdata = new HfsPlusForkData(params.getCatalogClumpSize(),
		...
		this.setNextAllocation((int) blockUsed - 1 - burnedBlocksAfterAltVH
				+ 10
	...
	public final String toString() {
		...
		buffer.append("Magic: 0x").append(NumberUtils.hex(getMagic(), 4))
				.append("\n");
		buffer.append("Version: ").append(getVersion()).append("\n")
				.append("\n");
		buffer.append("Attributes: ").append(getAttributesAsString())
				.append(" (").append(getAttributes()).append(")").append("\n")
				.append("\n");
		buffer.append("Create date: ")
				.append(HfsUtils.printDate(getCreateDate(),
						"EEE MMM d HH:mm:ss yyyy")).append("\n");
		buffer.append("Modify date: ")
				.append(HfsUtils.printDate(getModifyDate(),
						"EEE MMM d HH:mm:ss yyyy")).append("\n");
		buffer.append("Backup date: ")
				.append(HfsUtils.printDate(getBackupDate(),
						"EEE MMM d HH:mm:ss yyyy")).append("\n");
		buffer.append("Checked date: ")
				.append(HfsUtils.printDate(getCheckedDate(),
						"EEE MMM d HH:mm:ss yyyy")).append("\n").append("\n");
		...
		buffer.append("Free blocks: ").append(getFreeBlocks()).append("\n")
				.append("\n");
		buffer.append("Next catalog ID: ").append(getNextCatalogId())
				.append("\n");
		...
		buffer.append("Finder Infos: ").append(getFinderInfo()).append("\n")
				.append("\n");
		buffer.append("Journal block: ").append(getJournalInfoBlock())
				.append("\n").append("\n");
